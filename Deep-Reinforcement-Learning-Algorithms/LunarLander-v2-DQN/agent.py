...
class Agent(object):
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        # In this implementation, we rely on the main training loop 
        # (in the notebook) to call the self.learn() function when ready.
        # If you wanted to learn immediately after every step, you'd call:
        # self.learn(gamma)
